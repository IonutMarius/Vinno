    ...
    chrome.tabs.getSelected(null, function(tab) {
        chrome.tabs.sendRequest(tab.id, {action: "getTitle"}, function(response) {
            ...
            if(response != undefined){
                ...
                $("#currentPlaying").html("<h2>Current playing:</h2><img src='"+imageUrl+"' width='320px' height='200px'/> <p id='content' data-value='"+response.title+"' data-url='"+imageUrl+"' >"+response.title+"</p>");
            }
